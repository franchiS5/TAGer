...
public static IIOMetadata metadatachange (IIOMetadata imageMetadata, HashMap tablaExif){
	
	metaexif(imageMetadata, tablaExif);
	return imageMetadata;
}


static void metaexif (IIOMetadata imageMetadata, HashMap tablaExif){
